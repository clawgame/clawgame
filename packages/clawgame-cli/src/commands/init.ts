          ...
          const customAnswers = await inquirer.prompt([
            {
              ...
              default: 54,
              validate: (v: number) => (v >= 35 && v <= 75) || 'Must be 35-75',
            },
            {
              type: 'number',
              name: 'floorBase',
              ...
              default: 45,
              validate: (v: number) => (v >= 30 && v <= 60) || 'Must be 30-60',
            },
            {
              type: 'number',
              name: 'concessionMin',
              ...
              default: 1.0,
              validate: (v: number) => (v >= -5 && v <= 10) || 'Must be -5 to 10',
            },
            {
              type: 'number',
              name: 'concessionMax',
            ...
            },
            {
              ...
              default: 0.25,
              validate: (v: number) => (v >= 0 && v <= 1) || 'Must be 0.0-1.0',
            },
            {
              type: 'number',
